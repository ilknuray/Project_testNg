...
public class US11_TC_003 {
    @Test
    public void testUS11_tc03() throws InterruptedException {
        ...
        //"12-Vendor Minimum quantity'den urunun minumum
       // miktari girebilir"
        fatmaPage.minOrderQ.click();

        actions.sendKeys("20").perform();
}
}
