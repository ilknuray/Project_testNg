...
public class US10_TC_002 {
    @Test
    public void testUS10_tc02() throws InterruptedException {
        ...
        //11-Vendor Attributes butonunu tiklar
        ReusableMethods.jsScrollClick(fatmaPage.atributes);

        //12 vendor color butonunu tiklar
        fatmaPage.color.click();

        //vendor urune ait tum renk seceneklerini secer
        fatmaPage.colorAllSelect.click();

       //13-Vendor size butonunu tiklar
        Thread.sleep(3000);
        actions.sendKeys(Keys.TAB).perform();
        actions.sendKeys(Keys.PAGE_DOWN).perform();
        actions.sendKeys(Keys.PAGE_DOWN).perform();
        fatmaPage.size.click();

        //14-Vendor urune ait Size secenegi; small, medium, large, extra large olmali
        ReusableMethods.jsScrollClick(fatmaPage.atributes);
        fatmaPage.sizeAllSelect.click();
