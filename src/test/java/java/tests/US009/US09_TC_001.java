...
public class US09_TC_001 {
    @Test
    public void testUS09_tc01() throws InterruptedException {
...
//        7-Vendor Store Manager butununa tiklar
       ...
       // 10-vendor yeni urun ekleme sayfasina gittigini test eder
        ...
        //12-vendor urunun Weight (kg) girer
       fatmaPage.weightBox.click();
        actions.sendKeys("20", Keys.ENTER).perform();
    }
}