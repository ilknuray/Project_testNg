...
public class US08_TC_002 {

    @Test
    public void testUS08_tc02() throws InterruptedException {
      ...
      //"13-Vendor Allow Backorders(on siparise izin ver) kisminda
       // Allow but notify customber'i(musteriye haber ver) tiklar"
        ReusableMethods.waitFor(1);
        fatmaPage.allowButNotifyCustomer.click();
