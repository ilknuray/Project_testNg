...
public class US018_TC01 {
    ...
    public void tc01() throws IOException {
     ...
     //   ReusableMethods.jsExecutorClick(page.refund);
        ...
        // 9-vendor ödeme listesinde "RequestID" bilgisinin oldugunu tet eder
        Assert.assertTrue(page.requestId.isDisplayed());
        ReusableMethods.getScreenshot("isim,requestId");
