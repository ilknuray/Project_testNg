...
public class US018_TC03 {
    ...
    public void TC03() throws IOException {
        ...
        actions.sendKeys(Keys.PAGE_DOWN).perform();
        //   9-vendor ödeme listesinde ne kadar urun alindigi "Amount" bilgisinin oldugunu test eder
        Assert.assertTrue(page.amount.isDisplayed());
        ReusableMethods.getScreenshot("isim,Amount");
